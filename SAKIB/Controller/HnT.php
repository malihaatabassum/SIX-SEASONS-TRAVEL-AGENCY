...
<script src="../SAKIB/View/js/HnT.js"></script>
<link rel="stylesheet" href="../SAKIB/View/css/hntA.css"></link>
</head>
<body>

    <?php
include '../SAKIB/Model/dbhntD.php';
...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" name ="hntA" onsubmit="return isValid();">
  <fieldset>
