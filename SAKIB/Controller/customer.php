...
<script src="../SAKIB/View/js/cus.js"></script>
<link rel="stylesheet" href="../SAKIB/View/css/cusA.css"></link>
</head>
<body>
    <?php
...
//String Validation  
    ...
    if(!$flag) 
    {
      ...
      $payments = input_data($_POST["payments"]);
        ...
        $res = reg($customerid, $fullname, $gender, $dob, $religion, $praddress, $peaddress, $email,  $phone, $package, $packageid, $packagetime, $paymentm, $payments);
        if($res) {
...
?>
<h1>Customer details adding</h1>
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" name ="cusA" onsubmit="return isValid();">
  <fieldset>
    ...
    <span id="paymentsErr"></span>
    <span style="color: red"><?php echo $paymentsErr; ?> </span><br><br>
