...
<script src="../SAKIB/View/js/cusUp.js"></script>
<link rel="stylesheet" href="../SAKIB/View/css/cusU.css"></link>
</head>
<body>
    <?php
...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" name ="cusUp" onsubmit="return isValid();">
  <fieldset>
