...
<script src="../SAKIB/View/js/TguideU.js"></script>
<link rel="stylesheet" href="../SAKIB/View/css/guideU.css"></link>
</head>
<body>
    <?php
include '../SAKIB/Model/dbguideD.php';
...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" name ="guideU" onsubmit="return isValid();">
    <fieldset>
