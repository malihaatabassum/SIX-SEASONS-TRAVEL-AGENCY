...
<script src="../SAKIB/View/js/TguideV.js"></script>
</head>
...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="GET" name ="guideV" onsubmit="return isValid();">
    <label for="guideid">Enter Customer Id to view hes/her details:</label>
    <input type="text" id="guideid" name="guideid">
    &nbsp;&nbsp;&nbsp;<input type="submit" value="Submit"><br>
    <span id="guideidErr"></span>
