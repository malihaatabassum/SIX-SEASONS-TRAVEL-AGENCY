...
<script src="../SAKIB/view/js/visaU.js"></script>
<link rel="stylesheet" href="../SAKIB/View/css/visaU.css"></link>
</head>
<body>

    <?php
include '../SAKIB/Model/dbvisaD.php';
...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" name ="visaU" onsubmit="return isValid();">
  <fieldset>
