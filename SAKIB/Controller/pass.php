...
<script src="../SAKIB/View/js/pass.js"></script>
<link rel="stylesheet" href="../SAKIB/View/css/pass.css"></link>
</head>
<body>
<?php
...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" name ="pass" onsubmit="return isValid();">
 <fieldset>
 <legend><h3>Password</h3></legend>
 <label for="password">Enter Old Password:</label>
 <input type="password" id="passwordo" name="passwordo">
 <span id="passwordoErr"></span>
 ...
 <br>
<div style="text-align : center"><a href="../SAKIB/view/Manager.php">Go Back</a><br>
